  ...
  return (
    <>
      ...
      <div className="pt-9 mx-6 text-center">
        <h1 className="mt-20 mr-3  font-bold  text-2xl text-blue-800">
        ...
        <div className=" relative mt-20 ">
          ...
          <div className="absolute -top-8 left-8 py-3 px-5 drop-shadow-2xl rounded-xl  bg-white">
            <h3 className="font-light p-1 text-[7px] uppercase">
              Great project
            </h3>
            <p className="text-xs">
          ...
          {/* bill adams card */}
          <div className=" absolute -bottom-10 right-2 bg-white p-1 w-1/5 drop-shadow-2xl rounded-xl border-2">
            <div className="flex items-center  ">
              ...
              />
              <div className="ml-1">
                <h3 className="font-bold text-[7px]">Bill Adams</h3>
                <p className="font-light text-[5px]">CEO Uptech</p>
              </div>
            </div>
